...
interface Student
{
void Accadamic(String name,int reg,float m1,float m2,float percentage);
}
interface Sports
{
...
class Result implements Student,Sports
{
    ...
    String item;
    int rank;
    public void Accadamic(String name,int reg,float m1,float m2,float percentage)
    {
        this.name=name;
        this.reg=reg;
        this.m1=m1;
...
class AccadamicAndSports
{
    public static void main(String args[]) {
        ...
        int rank=sc.nextInt();
        R.Accadamic(name,reg,m1,m2,percentage);
